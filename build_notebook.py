...
cells.append(code([
    ...
    "    print(\"⚠️  Applied temporary patch: `data_feeds.lookup_cik` placeholder added.\")\n",
    "\n",
    "try:\n",
    "    # --- Incremental Prices ---\n",
    "    print(\"\\n📈 Checking price data...\")\n",
    ...
    "        if len(filings) == 0:\n",
    "            print(\"  ⚠️  WARNING: 0 filings were fetched.\")\n",
    "\n",
    "finally:\n",
    "    conn.close()\n",
    "\n",
...
cells.append(code([
    ...
    "    print(\"  ✅ ETF auto-selector loaded and active\")\n",
    "except ImportError:\n",
    "    print(\"  ⚠️ ETF selector not available — using legacy SPDR tickers\")\n",
    "\n",
    ...
    "        print(f\"  ✅ Active — Fidelity: {sorted(fidelity_check)}, Franklin: {sorted(franklin_check)}, Cash: {'SGOV' if sgov_check else 'N/A'}\")\n",
    "    if spdr_check:\n",
    "        print(f\"  ⚠️  SPDR tickers still present (not substituted): {sorted(spdr_check)}\")\n",
