...
def _fetch_price_history(tickers: List[str], period: str = "2y") -> pd.DataFrame:
    ...
    Returns wide-format DataFrame (date × ticker) of adjusted close prices.
    """
    import yfinance as yf
...
def apply_valuation_filter(info: dict, cfg: dict) -> str:
    ...
    # Implied 3-year earnings growth = (Forward P/E × discount_rate) - 1
    # Simplified: if P/E = 25 and r = 8%, implied growth ≈ 25 × 0.08 = 2.0 (100% growth)
